# GOU Problem - Gene Over/Under Expression Optimization Problem
...
problem = GOUProblem(model, fevaluation = [evaluator_1, evaluator_2], envcond=environ_conditions, candidate_max_size=5)
...
print(mutante_run)
lista_genes = open('3b_GOU_list_WYIELD.txt', 'w')
